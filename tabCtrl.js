const homework=[
 ...
 },   
 {
    ...
    <div id="sepEighteenth">
        ...
        <fieldset>
        <legend>基本資料 / Basic Information</legend>
            ...
            <fieldset>
                <legend>出生日期 / Date Of Birth</legend>
            ...
            <label for="email">電子信箱 / Email</label>
                <input id="email" type="email" name="email" placeholder="examplemail.com" required/>
            <label>聯絡電話 / Contact Number</label>
                ...
                <label for="com">公司 /Office</label>
                    <input id="com" type="tel" name="tel"/>
            <label for="address">通訊地址 / Mailing Address</label>
                <select id="cty">
                    <option value="" selected>請選擇縣市別 County/City</option>
                    <!--使用JS動態產生opt-->
                </select>    
                <select id="town">
                    <option value="" selected>請選擇鄉鎮區別 Township</option>
                    <!--使用JS動態產生opt-->
                </select>  
        ...
        <fieldset>
        <legend>競賽項目資料 / Race Category Information</legend>
            <fieldset>
        ...
        <fieldset>
            <legend>報到方式(二擇一) / Check-in Method</legend>
            ...
            <fieldset>
                ...
                <label>地點：花博爭豔館 (臺北市中山區玉門街1號)</label>
                <span>時間：</span>
        ...
        <fieldset>
            <legend>其他 / Others</legend>
            <label for="website">個人網站 / Website (選填)</label>
            <input id="website" type="text" name="website" placeholder="https://"/>
